...
export default function Navbar() {
  ...
  const [cartCount, setCartCount] = useState(1) // Add state for cart count
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <a href="#" className="group -m-2 flex items-center p-2" onClick={toggleMode} style={{ color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <Link to={'/cart'} className="group -m-2 flex items-center p-2" style={{ color: mode === 'dark' ? 'white' : '', }}>
                    <svg className="flex-shrink-0 h-6 w-6" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
                      <path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l1.6 8M7 13L5.4 7H4m0 0L3 3m0 0h2m0 0h2" />
                    </svg>
                    <span className="ml-2 text-sm font-medium text-gray-700">{cartCount}</span> {/* Use cart count state */}
